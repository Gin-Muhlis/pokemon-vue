<template>
    <div class="w-full px-5 lg:px-28 py-5 border flex items-center justify-between gap-5">
        <!-- Logo dan icon untuk ke home page -->
        <RouterLink to="/">
            <img src="/images/poke.png" alt="Pokemon Icon" class="icon-poke w-32 lg:w-40 object-cover">
        </RouterLink>
